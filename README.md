...
```javascript
typemax = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-type-max@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/utils-type-max/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/utils-type-max/actions/workflows/test.yml?query=branch:v0.1.1
